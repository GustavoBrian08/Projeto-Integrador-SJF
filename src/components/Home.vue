          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              <td><strong>Matricula: </strong><img v-if="!users.nome" src="http://portal.ufvjm.edu.br/a-universidade/cursos/grade_curricular_ckan/loading.gif/@@images/image.gif" style="width: 40px;">
                 {{users.matricula}}</td>
              <td><strong>Ingressou: </strong><img v-if="!users.nome" src="http://portal.ufvjm.edu.br/a-universidade/cursos/grade_curricular_ckan/loading.gif/@@images/image.gif" style="width: 40px;"><span v-else >{{ users.ingressou }}/2</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2"><strong>Curso: </strong><img v-if="!users.nome" src="http://portal.ufvjm.edu.br/a-universidade/cursos/grade_curricular_ckan/loading.gif/@@images/image.gif" style="width: 40px;"><spam v-else >16MINF - Técnico em {{ users.turma }}</spam> </td>
            </tr>
            <tr>
              <td colspan="1"><strong>Periodo: </strong><img v-if="!users.nome" src="http://portal.ufvjm.edu.br/a-universidade/cursos/grade_curricular_ckan/loading.gif/@@images/image.gif" style="width: 40px;"><spam v-else > {{ users.ingressou }}</spam> </td>
            </tr>
          </tbody>
        </table>
      </div>
          ...
          onAuthStateChanged(auth, async (user) => {
              if (user !== null) {
                  ...
                  const usuario = onSnapshot(doc(db, "Usuarios", user.uid), (doc) => {
                      ...
                      this.users = {nome: this.capitalizeFirst(this.users.nome), matricula: this.users.matricula, email: this.users.email, turma: this.capitalizeFirst(this.users.turma), ingressou: ingressou}
                  });
              }
              });
