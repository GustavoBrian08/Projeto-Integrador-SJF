<template>
    <div class="input-group mb-2">
        <input :type="type" :class="verificar" :value="modelValue" @input="updateValue" aria-label="Senha" aria-describedby="basic-addon1">
...
<script>
    export default{
        ...
        props:{
            verificar: String,
            modelValue: [String, Number], //fazer meu componente inputSenha  comunicar com o pai e filho 
            name: [String]
        },
        data(){
            return{
