    ...
    <div class="container d-flex justify-content-center align-items-center"> 
        <div id="cardSolicitacao" class="card rounded p-2 w-75 shadow-sm">
            <div class="d-flex flex-column card-body " style="max-height: 598px;">
                <h3 class="mb-4 d-flex justify-content-center">Solicitações de Professores</h3>
                <p class="alert alert-success" :style="success">Professor aceito com sucesso!</p>
...
const user = auth.currentUser;
    ...
    export default{
        ...
        async created(){
            const q = query(collection(db, "Usuarios"), where("isValidado", "==", false), where ("isAluno" , "==", 1));
